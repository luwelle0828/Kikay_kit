        ...
        <div class="content mt-3">
            <div class="row">                            
                <div class="col-md-12">
                    ...
                    <div>
                    <a href="<?php echo base_url('admin_view_client'.'?id='.$branch[0]->cm_id);?>" class="btn btn-primary" style="border-radius:3px;"><i class="fa fa-arrow-circle-o-left"></i> Back</a>
                    </div>
                    <br>
                </div>
            </div>
