...
<head>
    ...
    <!-- DATE & TIME PICKER -->
    <link href="<?php echo base_url("assets/css/datetimepicker/bootstrap-datetimepicker.css");?>" rel="stylesheet"/>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="<?php echo base_url('client_home');?>"> <i class="menu-icon fa fa-info-circle"></i>Information</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('client_reservations');?>"><i class="menu-icon fa fa-calendar"></i>Reservations</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('client_branches');?>"><i class="menu-icon fa fa-sitemap"></i> Branches</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('client_services');?>"><i class="menu-icon fa fa-cogs"></i> Services</a>
                    </li>      
                </ul>
            </div>
        </nav>
