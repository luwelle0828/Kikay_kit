    ...
    <div class="content mt-3">
        <div class="row">                   
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-10"><label><?php echo $info[0]->cm_company?></label></div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-2"><label class="form-control-label"><b>Company Description: </b></label></div>
                            <div class="col-12 col-md-10"><label><?php echo $info[0]->cm_desc?></label></div>
                        </div>
                    </div> 
                </div>
                <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <strong>Main Branch Information</strong>
                    </div>
                    <div class="card-body">
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-10">
                                ...
                                <br>
                                <button id="info-image-btn" class="btn btn-warning" style="margin-top: 10px; border-radius:3px; margin-right: 5px" data-toggle="modal" data-target="#update-client-image"><i class="fa fa-pencil"></i> Update Image</button>
                            </div>
                            
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-2"><label class="form-control-label"><b>Location: </b></label></div>
                        ...
                        <div class="row form-group">
                            <div class="col col-md-2"><label class="form-control-label"><b>Total Branches: </b></label></div>
                            <div class="col-12 col-md-10"><label><?php echo $count[0]->br_count?></label></div>
                        </div>
                        <div class="row form-group">
   ...
   <!-- MODAL FOR INFO UPDATE -->
            ...
            <div class="modal-content">
                <div class="card" align="left">
                    ...
                    <div class="card-body card-block">
                        <form action="<?php echo base_url('client_update_info'.'?id='.$info[0]->cm_id); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="row form-group">
                                <div class="col col-md-3"><label class="form-control-label">Company Name</label></div>
                                <div class="col-12 col-md-9"><input type="text" name="company" class="form-control" value="" required></div>
                            </div>       
                            <div class="row form-group">
    ...
    <div class="modal fade" id="update-client-image" tabindex="-1" role="dialog" aria-hidden="true">
