                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                        ...
                                        ?>
                                                        <tr align="middle">
                                                            <td><?php echo $val->br_no?></td>
                                                            <td><?php echo $val->br_name?></td>
                                                            <td><?php echo $val->br_location?></td>
                                                            <td><?php echo $val->br_mobile?></td>
                                                            <td><?php echo $val->br_telephone?></td>
                                                            <td><?php echo $val->br_opening.' - '.$val->br_closing?></td>
                                                            <td>
                                                                <a href="<?php echo base_url('client_view_branch'.'?id='.$val->br_id);?>" class="btn btn-outline-info" style="padding: 2px 5px 2px; border-radius:3px;"><i class="fa fa-eye"></i> View</a>
                                        ...
                                        <?php               if ($val->u_id != $_SESSION['id']) { 
                                                                echo'    
                                                                <button value="'.$val->br_id.'" class="btn btn-outline-danger" style="padding: 2px 8px 2px; border-radius:3px;" data-toggle="modal" data-target="#deact-branch"><i class="fa fa-level-down"></i> Deactivate</button>';
                                                            }
                                        ?>   
                                                            </td>
                                                        </tr>
                                    ...
                                    <table id="bootstrap-data-table2" class="table table-striped table-bordered">
                                        ...
                                        ?>
                                                        <tr align="middle">
                                                            ...
                                                            <td>
                                                                <a href="<?php echo base_url('client_view_branch'.'?id='.$val->br_id);?>" class="btn btn-outline-info" style="padding: 2px 5px 2px; border-radius:3px;"><i class="fa fa-eye"></i> View</a>
                                                                <button value="<?php echo $val->br_id?>" class="btn btn-outline-warning" style="padding: 2px 6px 2px; border-radius: 3px;" data-toggle="modal" data-target="#update-branch"><i class="fa fa-pencil"></i> Update</a>'
                                                                
                                        <?php               if ($val->u_id != $_SESSION['id']) { 
                                                                echo'    
                                                                <button value="'.$val->br_id.'" class="btn btn-outline-success" style="padding: 2px 8px 2px; border-radius:3px;" data-toggle="modal" data-target="#act-branch"><i class="fa fa-level-up"></i> Activate</button>';
                                                            }
                                        ?>                   
                                                            </td>
                                                        </tr>
            ...
            <div class="modal-content">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                        <form action="<?php echo base_url('client_add_branch'); ?>" method="post" class="form-horizontal">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-md-3"><input type="text" id="comp_input" name="branch_pre" class="form-control" value="<?php echo $val->cm_company?> - " readonly required></div>
                                <div class="col-md-6"><input type="text" name="branch_ex" class="form-control" required></div>
                            </div>
                            <div class="row form-group">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="card" align="left">
                    ...
                    <div class="card-body card-block">
                        <form action="<?php echo base_url('client_update_branch'.'?id='.$val->br_id);?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3"><label class="form-control-label">Branch Name</label></div>
                                <div class="col-md-3"><input type="text" name="branch_pre" class="form-control" value="" readonly required></div>
                                <div class="col-md-6"><input type="text" name="branch_ex" class="form-control" value="" required></div>
                            </div>                                           
                            <div class="row form-group">
